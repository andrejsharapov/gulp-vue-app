...
const 
    counterts = '/src/json/count.json',
    all_skills = '/js//json/skills.json',
    certs = '/src/json/certs.json',
    cases = '/src/json/cases.json',
    coding = '/src/json/coding.json',
    tline = '/src/json/timeline.json',
    pricing = '/src/json/pricing.json',
    siteisit = '/src/json/siteisit.json',
    bnr = '/src/json/bnr.json';
